...
def load_comments(csv_path):
    ...
    return all_comments, all_labels, all_topic, all_title, all_id, unique_id, sent_to_related, all_transcripts, df
...
def train_split_balance(all_comments, all_topics, all_labels, percentage=0.6):
